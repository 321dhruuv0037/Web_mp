...
import '../Components/NavbarStyles.css'; // Import custom CSS
    ...
    return (
      <nav className="navbar navbar-dark bg-dark ">
        <div className="container-fluid">
          ...
          </Link><h1 className="navbar-title">VeBook</h1>
            ...
            <div className="offcanvas-body">
              <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
                <li className="nav-item">
                  <Link className="nav-link active" aria-current="page" to="/customer-dashboard">
                    Home <FaHome />
                  </Link>
                </li>
                <li className="nav-item">
